...
def generate_launch_description():
    ...
    # 包路径
    pkg_share = FindPackageShare('probot_description')

    # xacro probot_description/urdf/probot_anno.xacro
    xacro_file = PathJoinSubstitution([pkg_share, 'urdf', 'probot_anno.xacro'])
